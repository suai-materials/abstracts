...
Структура:
* [Основные понятия и определения](#1.1)
  + [Структура и функции банков данных.](1.1)
  + [Лингвистические средства ](#1.2)
  + [Программные средства](#1.3)
  + [Технические средства](#1.4)
  + [Пользователи баз данных](#1.5)
  + [Классификация СУБД](#1.6)
  + [Клиент-Серверные СУБД](#1.7)
* [Типы моделей данных](#2)
    + [Проектирование баз данных](#2.1)
* [Язык SQL](#3)
    + [Достоинства и недостатки:](#3.1)
    + [Типы данных в SQL](#3.2)
...
Каждый объект имеет набор опр. свойств. Атрибут - это информационное отображение свойств объекта.
...
Различают три уровня предоставления данных: внешний, концептуальный и внутренний.
...
### Пользователи баз данных<a id="1.5"/>

Конечные пользователь, как правило, имеют дело со внешним интерфейсом поддерживаемым СУБД. Но есть администратор БД(АБД)
который:
...
- управление данными во внешней памяти - эта функция включает обеспечение необходимых структур внешней памяти как для
...
### Клиент-Серверные СУБД<a id="1.7"/>
...
### Проектирование баз данных<a id="2.1"/>
...
### Достоинства и недостатки:<a id = "3.1"/>
